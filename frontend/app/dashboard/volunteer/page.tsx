        ...
        <aside className="w-64 bg-white border-r border-border min-h-screen hidden lg:block">
          <div className="p-6">
            ...
            <nav className="space-y-1">
              <NavItem active={activeTab === 'my-projects'} onClick={() => setActiveTab('my-projects')} icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>} label="Мои проекты" />
              <NavItem active={activeTab === 'my-reports'} onClick={() => setActiveTab('my-reports')} icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/></svg>} label="Мои отчеты" />
        ...
        <main className="flex-1 p-4 md:p-8">
          ...
          {activeTab === 'my-reports' && (
            <div className="space-y-4">
              <h2 className="text-lg font-semibold">Мои отчеты</h2>
              <MyReportsPanel />
            </div>
          )}
